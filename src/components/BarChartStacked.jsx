...
import { mockBarDataStackedYear,mockBarDataStackedMonth,mockBarDataStackedWeek,mockBarDataStackedDay } from '../data/mockData';
...
const BarChartStacked  = ({ isDashboard = false }) => {
  ...
  return (
		<>
		<FormControl sx={{marginTop:'20px', marginLeft:'20px', marginBottom:'-40px'}}>
      <RadioGroup
        row
